...
# Based on "crates/build/re_type_definitions/rerun/blueprint/views/data_table.def.rs".
...
class DataTableView(View):
    """
    **View**: A dense view for grouped DataTable data, with sorting, dropdowns, and checkboxes.
    ...
    def __init__(
        ...
        *,
        ...
        """
        Construct a blueprint for a new DataTableView view.
